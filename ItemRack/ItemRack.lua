...
local loader = CreateFrame("Frame",nil, UIParent, BackdropTemplateMixin and "BackdropTemplate") -- need a new temp frame here, ItemRackFrame is not created yet
...
function ItemRack.ChatLinkID(itemID)
	...
	elseif inv then
		ChatFrame1EditBox:Insert(C_Container.GetInventoryItemLink("player",inv))
	else
